...
Plugin metadata is hosted in [this repository](https://github.com/LightTable/plugin-metadata). Follow the [project's instructions](https://github.com/LightTable/plugin-metadata#submit-a-plugin) to add or update your plugin.
